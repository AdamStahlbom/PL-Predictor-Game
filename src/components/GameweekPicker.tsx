...
export default function GameweekPicker({
  ...
  return (
    <div className="space-y-6">
      {/* Själva Gameweek-väljaren */}
      <div className="flex items-center justify-between mb-1 bg-white p-2 sm:p-3 rounded-2xl shadow-sm border border-gray-100 relative z-10">
        <button
        ...
        <button
          onClick={() =>
            handleGameweekChange(Math.min(38, currentGameweek + 1))
          }
